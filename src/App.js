  ...
  render() {
    return (
      <div className="App">
        ...
        />
        <header >
          <h1 className="title f1">BLOCKCHAIN DEMO</h1>
        </header>
        <div>
          <Blockchains />
        </div>
